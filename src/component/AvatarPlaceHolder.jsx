...
export default function Avatar() {
  return (
    <div>
      <a >
        <svg
          class="text-gray-200 dark:text-white-700 w-16 h-16 p-1 rounded-full ring-2 ring-gray-300 dark:ring-gray-500"
          aria-hidden="true"
          fill="currentColor"
          viewBox="0 0 20 20"
        ...
        <p className="text-center  text-gray-200 text-sm mt-1">Loading...</p>
      </a>
